            ...
            <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
                <div class="mb-6 flex flex-col items-center gap-4">
                    <div class="flex w-full max-w-md justify-center gap-4">
                        <button
                            type="button"
                            class="flex-1 rounded-xl bg-green-600 px-6 py-4 text-lg font-semibold text-white shadow-md transition hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                            @click="openAdd"
                        >
                            Sumar puntos
                        </button>
                        <button
                            type="button"
                            class="flex-1 rounded-xl bg-red-600 px-6 py-4 text-lg font-semibold text-white shadow-md transition hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                            @click="openSubtract"
                        >
                            Restar puntos
                        </button>
